...
const FeedBack = () => {
    return (
        <section className="mb-20 lg:px-[46px]">
            <div className='custom-container'>
                <div className='relative z-0 flex justify-between items-end w-full h-[350px]'>
                    <div className=" z-10  bg-[#77060B]  blur-[200px] rounded-full absolute top-[121px] left-[382px]" />
                    <img src={LeftMenImage} alt="men "/>

                    <div className=" bg-[#5B0408] w-[460px] full h-fit rounded-[12px] relative z-50  py-4 px-4 ">
                        ...
                        <p className='xl:text-xs lg:text-[10px] size text-white'>I’ve Been Using Fitmaker For The Past Three Months, And I’m Genuinely Impressed. The Website Is Easy To Navigate, And Everything Is Laid Out Clearly. I Purchased The Premium Plan, And The Personalized Coaching Has Been A Game-Changer For Me. My Coach Is Incredibly Supportive And Always Available To Answer My Questions. The Weekly Video Sessions Keep Me Motivated, And The Custom Meal Plans Have Helped Me Stay On Track With My Goals. Highly Recommended For Anyone Serious About Their Fitness Journey!</p>
                    </div>
                    ...
                    <div className="flex gap-4 ml-6 none">
