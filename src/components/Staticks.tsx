const Staticks = () => {
    return (
        <div className="custom-container flex items-center space-x-4">
            <div className="flex items-center">
                <div className="flex flex-col items-center w-[299px] h-[86px] mt-[18px]">
                    <div className="flex items-baseline mb-1">
                        <h2 className="text-[#D90A14] text-4xl font-bold">96%</h2>
            ...
            <div className="flex items-center">
                <div className="flex flex-col items-center w-[299px] h-[86px] mt-[18px]">
                    <div className="flex items-baseline mb-1">
                        <h2 className="text-[#D90A14] text-4xl font-bold">+5</h2>
            ...
            <div className="flex items-center">
                <div className="flex flex-col items-center w-[299px] h-[86px] mt-[18px]">
                    <div className="flex items-baseline mb-1">
                        <h2 className="text-[#CD4E17] text-4xl font-bold">+800</h2>
