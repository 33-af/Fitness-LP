...
const Staticks = () => {
    ...
    return (
        <div ref={ref} className=" flex items-center justify-center lg:middle-container  xl:custom-container  max-[430px]:small-container max-[430px]:mb-9 ">

            <div className="lg:w[928px] xl:w-[1244px] flex items-center max-[430px]:flex  max-[430px]:items-center max-[430px]:flex-col max-[430px]:h-[316px] ">
                <div className="flex items-center justify-center max-[430px]:flex max-[430px]:flex-col max-[430px]:mb-3">
                    <div className="flex flex-col items-center lg:w-[226px] lg:h-[105px] xl:w-[299px] xl:h-[86px] pt-4 pb-4    max-[430px]:pt-0  max-[430px]:pb-0 max-[430px]:mb-3">
                        <div className="flex items-baseline mb-1">
                            <motion.h2 className="text-[#D90A14] xl:font-bold  text-4xl  lg:text-[32px]  max-[430px]:text-[24px]">
                    ...
                    <span className="block h-[86px] w-1 bg-gradient-to-r from-[#D90A14] to-[#CD4E17] ml-2   max-[430px]:ml-0  max-[430px]:h-1  max-[430px]:w-[140px]" />
                </div>

                <div className="flex items-center justify-center max-[430px]:flex max-[430px]:flex-col max-[430px]:mb-3">
                <div className="flex flex-col items-center lg:w-[226px] lg:h-[105px] xl:w-[299px] xl:h-[86px] pt-4 pb-4    max-[430px]:pt-0  max-[430px]:pb-0 max-[430px]:mb-3">
                        <div className="flex items-baseline mb-1">
                            <motion.h2 className="text-[#CD4E17] xl:font-bold  text-4xl  lg:text-[32px]  max-[430px]:text-[24px]">
               ...
               <div className="flex items-center justify-center max-[430px]:flex max-[430px]:flex-col max-[430px]:mb-3">
                    <div className="flex flex-col items-center lg:w-[226px] lg:h-[105px] xl:w-[299px] xl:h-[92px] pt-6 pb-6  max-[430px]:pt-0  max-[430px]:pb-0 max-[430px]:mb-3 ">
                        <div className="flex items-baseline mb-1">
                            <motion.h2 className="text-[#D90A14] xl:font-bold  text-4xl  lg:text-[32px]  max-[430px]:text-[24px] ">
                ...
                <div className="flex items-center justify-center max-[430px]:flex max-[430px]:flex-col max-[430px]:mb-3">
                    <div className="flex flex-col items-center lg:w-[226px] h-[105px] xl:w-[299px] h-[92px] pt-6 pb-6  max-[430px]:pt-0  max-[430px]:pb-0 max-[430px]:mb-3 ">
                        <div className="flex items-baseline mb-1">
                            <h2 className="text-[#CD4E17] xl:font-bold  text-4xl  lg:text-[32px] max-[430px]:text-[24px]  ">24/7</h2>
