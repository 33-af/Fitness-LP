...
const Footer = () => {
    return (
        <footer className=" bg-[#181818]  w-full ">
            <div className=" custom-container pt-[60px]  pb-[67px]">
                <div className="flex items-start  justify-between">
                    <div className="flex flex-col w-[515px] mr-3">
                        <img src={FooterLogo} alt="footer-logo" width={151} height={63} />
                        <div className="text-base text-[#888888] text-justify mb-6 font-medium">
                    ...
                    <div className="flex  w-[515px] h-[301px] gap-1 ">

                        <div className="flex flex-col  w-[169px]">
                            <h2 className='text-[#D90A14] text-[20px] text-center mb-9'>Company</h2>
                            <div className="text-[#888888] text-[14px] text-center ">
                                <p className='mb-6'>About us</p>
                                <p className='mb-6'>Our Services</p>
                                <p className='mb-6'>Careers</p>
                        ...
                        <div className="flex flex-col  w-[169px] ">
                            <h2 className='text-[#D90A14] text-[20px] text-center mb-9'>Resources</h2>
                            <div className="text-[#888888] text-[14px] text-center ">
                                <p className='mb-6'>Fitness tools</p>
                                <p className='mb-6'>Workout Videos</p>
                                <p className='mb-6'>Nutrition Guides</p>
                                <p className='mb-6'>FAQ</p>
                                <p className='mb-6'>Success Stories</p>
                                <p>Membership </p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col  w-[169px]">
                            <h2 className='text-[#D90A14] text-[20px] text-center mb-9'>Programs</h2>
                            <div className="text-[#888888] text-[14px] text-center ">
                                <p className='mb-6'>Weight Loss</p>
                                <p className='mb-6'>Building Muscles</p>
                                <p className='mb-6'>Home Workout</p>
                                <p className='mb-6'>Gym Plan</p>
                                <p className='mb-6'>Our Plans</p>
                    ...
                    <div className="flex flex-col w-[190px] h-[187px] ml-3">
                        <h2 className='text-[#D90A14] text-[20px] text-center mb-9'>Contact Us</h2>
